...
<body>
    <div class="logout">
        <!-- <img src="./assets/images/on-button.png" alt=""> -->
    ...
    <script>
        ...
        function prfl() {
            ...
            exm.innerHTML = "<div class='profile'><div class='hi'>Hi,<?php echo ' ', $name; ?></div><div class='em'><?php echo $email; ?></div><div class='acc_no'><mark class='accn'><?php echo $acc_no; ?></mark></div><br><div class='bal'>Balance <mark class='bala'>₹<?php $balance = mysqli_fetch_assoc(mysqli_query($con, "SELECT balance FROM user WHERE acc_no='$acc_no'"))['balance'];
                                                                                                                                                                                                                                                                            echo $balance; ?></mark</div></div>";
        ...
        function trht() {
            ...
            pill.style.left = th.offsetLeft + "px";
            pill.style.width = th.offsetWidth + "px";

            exm.innerHTML = "<?php if (isset($_POST['d1']) && isset($_POST['d2']) && $d2 > $d1) {
                                ...
                                } ?><div class='containerx1'><ul class='responsive-table ulx1'><li class='table-header'><div class='col c1h col-1'>Date</div><div class='col col-2'>To/From</div><div class='col col-3'>Amount</div><div class='col col-4'>Balance</div> </li></ul><div class='containerx'><ul class='responsive-table'><?php $ii = 0;
                                                                                                                                                                                                                                                                                                                                        while ($rows = $result->fetch_assoc()) {
                                                                                                                                                                                                                                                                                                                                            if ($ii == 0) { ?><div class='frstwrap'><div class='dtind'><?php echo date_format(date_create($rows['datetime']), 'd/m/y');
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            $cur_date = date_format(date_create($rows['datetime']), 'd/m/y');
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            $GLOBALS['frstdate'] = date_format(date_create($rows['datetime']), 'Y-m-d'); ?></div><div class='frto'><form action='?tr=done' method='POST'><input type='date' id='d1' name='d1'> to <input type='date' id='d2' name='d2'></form></div></div><div class='backk'><?php } else if ($cur_date !== date_format(date_create($rows['datetime']), 'd/m/y')) { ?></div><div class='dtind'><?php echo date_format(date_create($rows['datetime']), 'd/m/y');
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        $cur_date = date_format(date_create($rows['datetime']), 'd/m/y');
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        $GLOBALS['lastdate'] = date_format(date_create($rows['datetime']), 'Y-m-d'); ?></div><div class='backk'><?php }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                $ii = 1; ?><li class='table-row'><div class='col col-1'><?php echo date_format(date_create($rows['datetime']), 'h:i A'); ?></div><div class='col col-2'><?php echo $rows['s_name']; ?></div><?php $am = intval($rows['amount']);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        if ($am > 0) {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            echo "<div class='col col-3 positive'>";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            echo $am;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            echo '</div>';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        } else {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            echo "<div class='col col-3 negative'>";
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            echo $am;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            echo '</div>';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        }  ?><div class='col col-4'>₹<?php echo $rows['current_bal']; ?></div></li><?php } ?></ul></div>";
            ...
            <?php } else { ?> d2.value = '<?php echo $GLOBALS['frstdate']; ?>';
        ...
        function usli() {
            ...
            pill.style.left = ul.offsetLeft + "px";
            pill.style.width = wth + "px";
            ...
            exm.innerHTML = "<?php $result = mysqli_query($con, " SELECT id,name,email,acc_no FROM user"); ?><div class='containerx1'><ul class='responsive-table ulx1'><li class='table-header'><div class='cola cola-1'>No</div><div class='cola cola-2'>Name</div><div class='cola cola-3'>Email</div><div class='cola cola-4'>Account No</div> </li></ul><div><div class='containerx'><ul class='responsive-table'><?php $m = 0;
                                                                                                                                                                                                                                                                                                                                                                                                                        while ($rows = $result->fetch_assoc()) {
                                                                                                                                                                                                                                                                                                                                                                                                                            $m += 1; ?><li class='table-row trn'><div class='cola cola-1'><?php echo $m; ?></div><div class='cola cola-2'><?php echo $rows['name']; ?></div><div class='cola cola-3'><?php echo $rows['email']; ?></div><div class='cola cola-4'><?php echo $rows['acc_no']; ?></div></li><?php } ?></ul></div></div>";
